// const a = `
// 1. <section> 요소는 일반적으로 콘텐츠를 장이나 절 등으로 구분하고자 할 경우에 적절하다.
// 2. 문서의 제목이나 이름을 나타내는 <title> 요소는 <head> 요소 안에 위치하며,
//   내용은 텍스트로만 작성할 수 있다.
// 3. <nav> 요소는 본문의 주요 내비게이션을 마크업할 때 사용할 수 있다.
// 4. <main> 요소는 <body> 영역의 주요 콘텐츠 블록을 그룹화할 때 사용할 수 있으며,
//   <body> 영역 안에 <main> 요소는 여러 번 사용할 수 있다.
// `;
// console.log(JSON.stringify(a));
console.log(JSON.stringify(`<!-- 설명문 -->`);
